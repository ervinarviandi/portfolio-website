...
export default function Example() {
  ...
  return (
    <div className="mx-auto  w-full py-16 sm:px-0">
      <Tab.Group manual>
        <Tab.List className="dark:bg-card100 dark:text-white mx-auto flex space-x-1 rounded-lg p-1 ">
          <Tab
            className={({ selected }) =>
              classNames(
                "delay-50 text-gradient100 font-poppins  w-full rounded-lg bg-[#fff] py-2.5 text-sm font-medium leading-5 shadow-lg transition duration-700 ease-in-out  hover:text-[#2bccb8] dark:bg-[#1e1e1e] ",
                selected
                  ? "text-white  dark:bg-[#1e1e1e] "
          ...
          <Tab
            className={({ selected }) =>
              classNames(
                "delay-50 w-full rounded-lg  bg-[#fff] py-2.5 text-sm font-medium leading-5 shadow-lg transition duration-700 ease-in-out hover:text-[#2bccb8] dark:bg-[#1e1e1e] ",
                selected
                  ? " dark:bg-[#1e1e1e] "
                ...
                isLoading
                  ...
                  <div className="p-4">
                    ...
                    <p className="md:text-md py-3 text-sm text-white-100 dark:text-dark-100">
                      {" "}
                      simple application that aims to make it easier for Muslims
                      to do morning and evening dhikr according to the guidance
                      of the Prophet sallallaahu &apos;alaihi wasallam via
                      mobile phones, tablets or website-based laptops.
                    </p>
