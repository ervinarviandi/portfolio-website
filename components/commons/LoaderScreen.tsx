...
const LoaderScreen = () => {
  return (
    <motion.section initial={{ y: 0, opacity: 1 }} animate={{ y: -1000, transition: { duration: 1, delay: 2.9 } }} className="fixed bg-gradient-to-tr from-[#7af080] via-[#e0ff7d] to-[#e0ff7d] z-[2000] w-full h-full  ">
